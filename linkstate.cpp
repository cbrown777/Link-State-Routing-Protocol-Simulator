...
void checkFilesStatus(const ifstream& topofileStream, const ifstream& changesfileStream){
...
int main(int argc, char** argv) {
    ...
    checkFilesStatus(topofileStream, changesfileStream);
...
// _____________________________________________________________________________________
    ...
    top_1.generateNodeForwardingTables();
    top_1.writeOutForwardingTablesForAllNodes(fileStreamOut);
    top_1.writeOutMessages(fileStreamOut, argv[2]);
