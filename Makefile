...
CPP = g++
COMPILERFLAGS = -std=c++14 -g -Wall -Wextra -Wno-sign-compare 
...
TOPOLOGYOBJECTS = obj/Topology.o
NODEOBJECTS = obj/Node.o

# NOT Using this because Edge is a STRUCT and ONLY has a header file
#EDGEOBJECTS = obj/Edge.o
...
linkstate: $(LINKSTATEOBJECTS) $(TOPOLOGYOBJECTS) $(NODEOBJECTS)
	$(CPP) $(COMPILERFLAGS) $^ -o $@ $(LINKLIBS)
